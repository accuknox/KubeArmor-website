  ...
  return (
    <div className="pt-3 px-3 pb-3 demopoliciestext demopoliciescard">
      <div style={{ width: '100%' }}>
        ...
        <p className="demopoliciesblack" style={{ marginLeft: '15px', marginBottom: '11px' }}>process:</p>
	      <p className="demopoliciesblack" style={{ marginLeft: '30px', marginBottom: '11px' }}>matchPaths:</p>
