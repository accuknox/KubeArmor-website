      ...
      <div className={`container-medium`}>
        ...
        <div className={styles.members}>
          <Link to="https://www.cncf.io/">
            <img className={styles.member} src={membershipLogo1} alt="member logo" />
          </Link>
          <Link to="https://lfx.linuxfoundation.org/">
            <img className={styles.member} src={membershipLogo2} alt="member logo" />
          </Link>
          <Link to="https://nephio.org/">
            <img className={styles.member} src={membershipLogo3} alt="member logo" />
          </Link>
          <Link to="https://openssf.org/">
            <img className={styles.member} src={membershipLogo4} alt="member logo" />
          </Link>
          <Link to="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2226443&HistoricalAwards=false">
            <img className={styles.member} src={membershipLogo5} alt="member logo" />
          </Link>
          <Link to="https://www.5gsec.com/">
            <img className={styles.member} src={membershipLogo6} alt="member logo" />
          </Link>
        </div>
      </div>
    </section>
